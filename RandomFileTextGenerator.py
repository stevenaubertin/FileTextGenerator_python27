...
Copyright (C) 2015 Remi Carpentier, Steven Aubertin
...
__author__ = 'Remi Carpentier, Quebec, Canada <carpentieremi@hotmail.com>','Steven Aubertin <stevenaubertin@gmail.com>'
...
def about():
    print """
            RandomFileTextGenerator Copyright (C) 2015  Remi Carpentier, Steven Aubertin
